  ...
  return (
    <div className="statusbar">
      ...
      <div className="sb-right">
        ...
        <Icon.wifi size={16} />
        <svg width="26" height="13" viewBox="0 0 26 13" fill="none" stroke="currentColor"><rect x="1" y="1" width="21" height="11" rx="3"/><rect x="3" y="3" width="15" height="7" rx="1.5" fill="currentColor"/><rect x="23.5" y="4.5" width="1.5" height="4" rx="1" fill="currentColor"/></svg>
      </div>
    </div>
  );
}
